  ...
  const crops = [
    {
      ...
      lastWatered: "2024-10-08",
      nextWatering: "2024-10-10",
      pruningSchedule: "Every 2 weeks",
      lastPruned: "2024-09-30",
      nextPruning: "2024-10-14",
      fertilizationSchedule: "Every 3 weeks",
      lastFertilized: "2024-09-25",
      nextFertilization: "2024-10-16",
    },
    {
      id: 2,
      name: "Strawberry",
      ...
      lastWatered: "2024-10-09",
      nextWatering: "2024-10-10",
      pruningSchedule: "Every month",
      lastPruned: "2024-09-20",
      nextPruning: "2024-10-20",
      fertilizationSchedule: "Every 2 weeks",
      lastFertilized: "2024-10-01",
      nextFertilization: "2024-10-15",
    },
    {
      id: 3,
      name: "Cucumber",
      ...
      lastPruned: "2024-09-25",
      nextPruning: "2024-10-16",
      fertilizationSchedule: "Every 2 weeks",
      lastFertilized: "2024-10-02",
      nextFertilization: "2024-10-16",
    },
    {
      id: 4,
      ...
      lastWatered: "2024-10-07",
      nextWatering: "2024-10-10",
      pruningSchedule: "Monthly",
      lastPruned: "2024-09-15",
      nextPruning: "2024-10-15",
      fertilizationSchedule: "Every 3 weeks",
      lastFertilized: "2025-01-20",
      nextFertilization: "2025-02-11",
    },
  ];
